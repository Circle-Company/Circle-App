...
class Analytics {
  ...
  trackEvent(eventName: string, eventData: EventData = {}): void {
    ...
    const eventObject: EventObject = { eventName: prefixedEventName, eventData, timestamp: currentTimestamp };
  ...
  startContentTimer(): void {
    this.contentTimerStart = Date.now();
  }

  stopContentTimer(contentId: string): void {
