...
export default function Last_active_at ({
    ...
    return (
        <View style={container}>
            <SignalIcon fill={color} width={12} height={12} style={{marginRight: sizes.margins["1sm"]*1.4}}/>
            <Text style={description_style}>{timeDifferenceConverter({date: String(user.last_active_at), small: false})}</Text>  
        </View>
    )
}