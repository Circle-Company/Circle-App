...
import { TextInput, useColorScheme, Animated, Pressable, View, Keyboard} from "react-native"
            ...
            <View style={container}>
                <View style={input_container}>
                    <View style={iconContainer}>
                        <SearchIcon
                            fill={String(colors.gray.grey_04)}
                            width={16}
                            height={16}
                        />                       
                    </View>                    
                    ...
                    {searchTerm &&
                        <Pressable style={iconContainer2} onPress={handleCancelPress}>
                            <CloseIcon
                                fill={String( isDarkMode? colors.gray.grey_03: colors.gray.grey_04)}
                                width={11}
                                height={11}
                            />                       
                        </Pressable>                          
