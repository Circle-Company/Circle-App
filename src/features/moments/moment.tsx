...
export default function RenderMoment({ data, isFocused, isFeed }: renderMomentProps) {
    ...
    return (
        ...
        >
            <Animated.View style={animated_container}>
                <Moment.Container contentRender={data.media} isFocused={isFocused} blurRadius={70}>
                    <Moment.Root.Top>
                        <Moment.Root.TopLeft>
            ...
            <Animated.View style={animated_comment_container}>
                <RenderComment moment={data} focused={isFocused} />
            </Animated.View>
        </Moment.Root.Main>
    )
}
