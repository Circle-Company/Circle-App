...
import { FlatList, Pressable, ScrollView, Text, TextInput, useColorScheme} from "react-native"
            ...
            renderItem={({item, index}) => {
                return (
                    <View key={index} style={tag_container}>
                        ...
                        <Pressable style={icon_container} onPress={() => {handlePress(index)}}>
                            <CloseIcon
                                fill={String(isDarkMode? `${colors.blue.blue_01}70` : `${colors.blue.blue_06}40`)}
                                width={7}
                                height={7}
                                strokeWidth={1.5}
                                stroke={String(isDarkMode? `${colors.blue.blue_01}70` : `${colors.blue.blue_06}40`)}
                                />
                        </Pressable>
                    </View>
                )
