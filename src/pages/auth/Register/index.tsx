...
import { SafeAreaView, StatusBar, StyleSheet, ScrollView, TouchableOpacity, Dimensions, Image, Pressable, TextInput} from 'react-native'
...
export default function SignUpScreen() {
  ...
  const inputError = {
    flex: 1,
    fontFamily: 'RedHatDisplay-Regular',
    color: ColorTheme().backgroundDisabled,
