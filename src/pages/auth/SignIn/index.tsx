...
export default function SignInScreen() {
    ...
    const button_text: any = {
        ...
        color: signInputUsername && signInputPassword? colors.gray.white: isDarkMode? colors.gray.grey_04 + '90' : colors.gray.grey_04 + '90',
    }
    const icon: any = {
    ...
    function handlePress() { if(signInputUsername && signInputPassword) signIn() }
    ...
    return (
        <View style={container}>
            ...
            <ButtonStandart
                    ...
                    height={40} 
                    action={handlePress}
                    backgroundColor={ signInputPassword && signInputUsername? ColorTheme().primary.toString() : ColorTheme().backgroundDisabled.toString()}
                >
                    <Text style={button_text}>Enter Now</Text>
                    <Icon
                        style={icon}
                        fill={String(signInputPassword && signInputUsername? colors.gray.white: isDarkMode? colors.gray.grey_04 + '90' : colors.gray.grey_04 + '90')}
                        width={17}
                        height={17}
                    />
                </ButtonStandart>
