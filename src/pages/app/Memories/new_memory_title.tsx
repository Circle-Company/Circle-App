...
import { StatusBar,  useColorScheme, FlatList, Animated, Keyboard, Platform} from 'react-native'
...
React.useEffect(() => {
  ...
  return (
    <View style={container}>
      ...
      <Animated.View style={{ transform: [{ scale: renderMemoryScale }], ...memory_container}}>
      ...
      <FlatList
        ...
        ListHeaderComponent={({item}) => {
          return (
            <View style={{width: sizes.margins['1xxl'] * 0.5}}></View>
          )
        }}
