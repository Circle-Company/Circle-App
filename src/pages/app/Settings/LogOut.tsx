...
export default function LogOutScreen() {
    ...
    async function handlePress() {
        try{
            const isAuthenticated = await TouchID.requestBioAuth(t("Make sure it's you"), t("You're logging out of your account"))
    ...
    return (
        <View style={container}>
            ...
            <View style={descriptionContainer}>
                <Text style={description}>{t('You will not be able to recover your account if you forget your password.')}</Text>
                <Text style={description}>{t("You won't be able to see or interact with Moments of those you follow.")}</Text>                
            </View>
            <ButtonStandart
            bounciness={5}
            animationScale={0.93}
