...
interface WhoToFollowContextProvider { children: React.ReactNode }
...
export function WhoToFollowContextProvider({children}: WhoToFollowContextProvider) {
    ...
    const fetchData = async () => {
        try{
            ...
            .then(function (response) { setUsersRecommendation(response.data) })
    ...
    return (
        <WhoToFollowContext.Provider value={contextValue}>
            {children}
