...
describe("ListUtils", () => {
    describe("getUniqueNewItems", () => {
        ...
        it("deve ser eficiente com listas grandes", () => {
            const baseList = Array.from({ length: 1000 }, (_, i) => String(i))
            const newList = Array.from({ length: 1000 }, (_, i) => String(i + 500))
    ...
    describe("limitListSize", () => {
        ...
        it("deve ser eficiente com listas grandes", () => {
            const list = Array.from({ length: 10000 }, (_, i) => String(i))
            const maxItems = 100
